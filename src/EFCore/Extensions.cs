...
namespace MSiccDev.ServerlessBlog.EFCore
{
    public static class Extensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            #region media type
            MediaType imgJpeg = new MediaType
            {
                Name = "JpegImage",
                MimeType = "image/jpeg",
                Encoding = null,
                MediaTypeId = Guid.Parse("029d456e-1019-4b6d-8b17-7c5d46479aa9")
            };

            MediaType imgPng = new MediaType
            {
                Name = "PngImage",
                MimeType = "image/png",
                Encoding = null,
                MediaTypeId = Guid.Parse("f6113ec3-5dd8-4451-a485-ec908cd13f5f")
            };

            MediaType videoMP4 = new MediaType
            {
                Name = "VideoMP4",
                MimeType = "video/mp4",
                Encoding = null,
                MediaTypeId = Guid.Parse("7fd73ef9-79bb-445c-8a46-9d46d89ad27e")
            };

            MediaType videoH264 = new MediaType
            {
                Name = "VideoH264",
                MimeType = "video/h264",
                Encoding = null,
                MediaTypeId = Guid.Parse("2048bf73-8830-4cf3-a820-69c2ac11f0b6")
            };
            ...
            #region media
            Media postImage1 = new Media()
            {
                MediaId = Guid.Parse("3b9831ad-e97e-4df9-a2b8-11b9193cb1d1"),
                BlogId = Guid.Parse("32f58fde-7258-4ffe-ac34-5ab88ea29f7e"),
                MediaUrl = new Uri("https://cdn.pixabay.com/photo/2018/03/10/12/00/teamwork-3213924_1280.jpg"),
            ...
            Media postImage2 = new Media()
            {
                MediaId = Guid.Parse("863502b4-4054-40e0-9fb8-834007e2f38d"),
                BlogId = Guid.Parse("32f58fde-7258-4ffe-ac34-5ab88ea29f7e"),
                MediaUrl = new Uri("https://cdn.pixabay.com/photo/2018/09/09/08/36/network-3664108_1280.jpg"),
            ...
            Media postImage3 = new Media()
            {
                MediaId = Guid.Parse("a818ba58-a714-492b-b18a-8de87dbec04a"),
                BlogId = Guid.Parse("32f58fde-7258-4ffe-ac34-5ab88ea29f7e"),
                MediaUrl = new Uri("https://cdn.pixabay.com/photo/2021/08/01/19/00/cloud-6515064_1280.jpg"),
            ...
            Post initPost1 = new Post()
            {
                ...
                Content = $@"<h2>The first post on this blog</h2>
                            ...
                            ",
                PostImageMediaId = Guid.Parse("a818ba58-a714-492b-b18a-8de87dbec04a"),
            ...
            Post initPost2 = new Post()
            {
                ...
                Content = $@"<h2>The second post on this blog</h2>
                            ...
                            <P>I absolutely recommend following my #CASBAN6 blog series where I explain a lot of the stuff I am doing during implementing this serverless blog engine.</P>
                            ",
                PostImageMediaId = Guid.Parse("863502b4-4054-40e0-9fb8-834007e2f38d"),
                Published = DateTimeOffset.MinValue,
            ...
            Post initPost3 = new Post()
            {
                ...
                Content = $@"<h2>The second post on this blog</h2>
                            ...
                            <P>I absolutely recommend following my #CASBAN6 blog series where I explain a lot of the stuff I am doing during implementing this serverless blog engine.</P>
                            ",
                PostImageMediaId = Guid.Parse("3b9831ad-e97e-4df9-a2b8-11b9193cb1d1"),
                Published = DateTimeOffset.MinValue,
