...
namespace MSiccDev.ServerlessBlog.ClientSdk
{
    public interface IBlogClient
    {
        ...
        Task<BlogEntitySet<TEntity>> GetEntityListAsync<TEntity>(string accessToken, Guid? blogId = null, int skip = 0, int count = 10, bool throwExceptions = true) where TEntity : DtoModelBase;
        Task<BlogEntity<TEntity>> GetEntityListAsync<TEntity>(string accessToken, Guid blogId, Guid? resourceId = null, bool includeDetails = false, bool throwExceptions = true) where TEntity : DtoModelBase;
